#ifndef _LOGWEIGHTPROB_H_
#define _LOGWEIGHTPROB_H_
...
public:
  ...
  //operator double() { return (double)getWeightProb(); }

  //double to_double() const{
  //  return (double)getWeightProb();
  //}

/* 
//code taken from veness
